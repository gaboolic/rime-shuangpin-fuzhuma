...
for file in file_list:
    ...
    with open(file_name, 'r') as file:
        ...
        for line in file:
            ...
            # print(shengmus)
            jianpin = shengmus[0][0] + shengmus[1][0] + shengmus[2][0] + shengmus[-1][0]
...
file_path = "custom_phrase_super_njian.txt"
with open(file_path, "w") as file:
    file.write("## 超强N简 使用deal_super_Njian.py生成\n")
...
e_file_path = "cn_dicts_common/changcijian.dict.yaml"
...
# 遍历字符串序列
    for combination in combinations:
        if combination not in jianpin_word_map:
            ...
            # 取出前三个元素
            word_freq_list = word_freq_list[:2]
            for word_freq in word_freq_list:
                word = word_freq['word']
